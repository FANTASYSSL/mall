package com.wch.e3mall.order.controller;
...
public class OrderController {
	...
	public String createOrder(OrderInfo orderInfo, HttpServletRequest request) {
		...
		//调用服务生成订单
		E3MallResult e3MallResult = orderService.createOrder(orderInfo);
		//如果订单生成成功，需要删除购物车
		...
		//把订单号传递给页面
		request.setAttribute("orderId", e3MallResult.getData());
